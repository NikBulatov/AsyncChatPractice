...
# каждое сообщение участника отправляется всем, подключенным к серверу. DONE

# 2. Реализовать функции отправки/приема данных на стороне клиента.
# Чтобы упростить разработку на данном этапе,
# пусть клиентское приложение будет либо только принимать, либо
# только отправлять сообщения в общий чат.
